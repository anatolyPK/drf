...
class ChangeCryptoTransactionTest(TestCase):
    ...
    def test_change_crypto_transaction_no_changes(self):
        ...
        AssetsChange.change_crypto_transaction(old_transaction, new_transaction)
    ...
    #     old_transaction = PersonsTransactions.objects.first()
    #     new_transaction = {
    #         'is_buy_or_sell': True,
    #         'token_1': 'eth',
    #         'token_2': 'usdt',
    ...
    #     self.assertEqual(edited_persons_crypro.token, 'eth')
    #     self.assertEqual(edited_persons_crypro.user, self.test_user1)
    #     self.assertAlmostEqual(edited_persons_crypro.average_price_in_rub, 2000, delta=0.001)
    #     self.assertAlmostEqual(edited_persons_crypro.average_price_in_usd, 200, delta=0.001)
    #     self.assertEqual(edited_persons_crypro.lot, 95)
    #
    # def test_change_crypto_transaction_change_buy_or_sell(self):
    #     old_transaction = PersonsTransactions.objects.first()
    #     new_transaction = {
    #         'is_buy_or_sell': False,
    #         'token_1': 'eth',
    #         'token_2': 'usdt',
    #         'lot': 20,
    #         'user': self.test_user1,
    ...
    #     self.assertAlmostEqual(edited_persons_crypro.average_price_in_rub, 2000, delta=0.001)
    #     self.assertAlmostEqual(edited_persons_crypro.average_price_in_usd, 200, delta=0.001)
    #     self.assertEqual(edited_persons_crypro.lot, 20)
    #
    #
    #
    #
